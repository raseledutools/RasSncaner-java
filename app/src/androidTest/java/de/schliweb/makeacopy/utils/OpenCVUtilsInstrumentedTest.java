...
/**
 * Umfassende Instrumented-Tests für OpenCVUtils.
 * Hinweis: Echte Testbilder werden später ergänzt – aktuell werden Platzhalter-Bitmaps verwendet.
 */
...
public class OpenCVUtilsInstrumentedTest {
    ...
    public void applyPerspectiveCorrection_identityMapping_returnsSameSize() {
        ...
        Point[] corners = new Point[]{
                ...
                new Point(src.getWidth() - 1.0, src.getHeight() - 1.0), new Point(0, src.getHeight() - 1.0)
        };
    ...
    public void applyPerspectiveCorrection_withWrongCornerCount_returnsSameInstance() {
        ...
        Point[] corners = new Point[]{ new Point(0,0), new Point(10,0), new Point(10,10) }; // nur 3 Punkte
        Bitmap out = OpenCVUtils.applyPerspectiveCorrection(src, corners);
