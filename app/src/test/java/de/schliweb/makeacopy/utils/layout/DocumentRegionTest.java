...
/**
 * Unit tests for DocumentRegion class.
 * Note: Tests that require Android Rect methods (equals, contains, width, height, intersects)
 * are skipped in JVM unit tests due to Android framework mocking limitations.
