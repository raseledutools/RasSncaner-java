...
/**
 * Minimal data model for editable OCR (schema 1) used by the Review screen.
 * This is intentionally decoupled from utils.RecognizedWord to avoid breaking existing code.
 */
public class OcrDoc {
    public int schema = 1;
