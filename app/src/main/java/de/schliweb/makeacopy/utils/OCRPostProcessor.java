...
public class OCRPostProcessor {
  ...
  /**
   * Processes a list of recognized words with dictionary-based correction. Words not found in the
   * dictionary are corrected by trying common OCR error substitutions.
   *
   * @param words The list of recognized words to process
  ...
  public static List<RecognizedWord> processWithDictionary(
      List<RecognizedWord> words, String language, Context context) {
