...
/**
 * Represents a detected region within a document image.
 * Used for layout analysis to identify different structural elements
 * like headers, body text, tables, figures, etc.
 */
@Getter
@Setter
