 ...
 *
 * <p>especially for classes of algorithms, for which there can be multiple implementations. The
 ...
 *
 * <p>Here is example of SimpleBlobDetector use in your application via Algorithm interface:
